...
extension CLLocationManager {
    ...
    static func determineUserLocation() -> Promise<CLLocation> {
        let locationManagerDelegate = LocationManagerDelegate()
        return locationManagerDelegate.determineUserLocation().then { userLocation -> CLLocation in
            // keep delegate around
            let _ = locationManagerDelegate
            return userLocation
        }
    }
